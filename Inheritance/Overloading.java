...
class TicketBooking {
	...
	public void makePayment(String creditCard,String ccv,String name,Double amount) {
		System.out.println(this.stageEvent+" "+this.customer+" "+this.noOfSeats+" "+name+" "+d.format(amount)+" "+creditCard+" "+ccv);
	}
	public void makePayment(String walletNumber ,Double amount) {
		System.out.println(this.stageEvent+" "+this.customer+" "+this.noOfSeats+" "+d.format(amount)+" "+walletNumber);
	}
